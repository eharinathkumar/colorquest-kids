# Upload ColorQuest Kids 2.5.0 to GitHub
...
7. Open `https://eharinathkumar.github.io/colorquest-kids/`. If an older cached copy appears, close the installed app/browser tab and reopen it once so the v2.5.0 offline cache can activate.
